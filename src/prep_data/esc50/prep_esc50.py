...
if os.path.exists("/engram/naplab/shared/ESC-50-master") == False:
    ...
    with zipfile.ZipFile(
        "/engram/naplab/shared/ESC-50-master.zip", "r"
    ) as zip_ref:
    ...
    audio_list = get_immediate_files(
        "/engram/naplab/shared/ESC-50-master/audio"
    )
...
label_set = np.loadtxt(
    "./esc_class_labels_indices.csv", delimiter=",", dtype="str"
)
label_map = {}
...
for fold in [1, 2, 3, 4, 5]:
    ...
    meta = np.loadtxt(
        "/engram/naplab/shared/ESC-50-master/meta/esc50.csv",
        delimiter=",",
        dtype="str",
        skiprows=1,
    )
