...
# Ensure this package's directory is on sys.path so absolute imports work
# regardless of how this module is loaded (as a package or via sys.path shim).
...
class UpstreamExpert(torch.nn.Module):
    def __init__(
        ...
        from upstream_models import AMBAModel

        try:
            if model_type == "p":
                print("importing ssast")
                from upstream_models import ASTModel
            else:
